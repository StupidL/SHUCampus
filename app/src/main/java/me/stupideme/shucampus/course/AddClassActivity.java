...
public class AddClassActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(AddClassActivity.this,
        ...
        ArrayAdapter<CharSequence> adapter1 = ArrayAdapter.createFromResource(AddClassActivity.this,
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Integer.parseInt(begin.getText().toString())>13||Integer.parseInt(end.getText().toString())>13){
                    ...
                    CampusApp.manager.insertClass(model);
                }
            }
        });
