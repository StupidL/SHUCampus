...
public class ReminderAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(getResources().getColor(R.color.colorPrimaryDark2, null));
        ...
        switch (item.getItemId()) {
            case R.id.actions_save:
                ...
                if (model.getId() != 0L) {
                    ...
                    DBManager manager = DBManager.getInstance(ReminderAddActivity.this);
                    ...
                    //notify receiver
                    Intent intent = new Intent(ReminderAddActivity.this, ReminderAlarmReceiver.class);
            ...
            case R.id.actions_alarm:
                ...
                new DatePickerDialog(ReminderAddActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        new TimePickerDialog(ReminderAddActivity.this, new TimePickerDialog.OnTimeSetListener() {
                            @Override
